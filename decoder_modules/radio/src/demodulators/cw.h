...
namespace demod {
    ...
    public:
        ...
        void showMenu() {
            ...
            ImGui::LeftLabel("Частота тону");
            ImGui::FillWidth();
            if (ImGui::InputInt(("Стерео##_radio_cw_tone_" + name).c_str(), &tone, 10, 100)) {
        ...
        double getMaxBandwidth() { return 1000.0; }
